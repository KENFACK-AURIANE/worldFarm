...
export default function RegisterPage() {
  ...
  // Récupération de la fonction register depuis le store Zustand
  // Cette fonction permettra d'envoyer les données au backend
  ...
  const onSubmit = async (data: RegisterInput) => {
    ...
    try {
      ...
      // redirect("/worldfarm/app/auth/verifierOtp");
